    ...
    <section className="about">
      <div className="sobre-container">
        ...
        <p className="sobre-text">
          Somos uma clínica de fisioterapia dedicada ao bem-estar e à
          recuperação física dos nossos pacientes. Com profissionais
          qualificados e técnicas modernas, oferecemos serviços personalizados
